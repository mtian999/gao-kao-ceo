...
export const FORM_PLACEHOLDER = 'http://gaokaoceo.com/';

export const WEBSITE_EXAMPLE =
  '<a href="http://gaokaoceo.com/" title="高考志愿参考工具 Tools Directory">高考志愿参考工具 Tools Diresctory</a>';
